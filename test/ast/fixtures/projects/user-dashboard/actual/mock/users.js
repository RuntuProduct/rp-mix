...
module.exports = {
  'GET /api/users': function GETApiUsers(req, res) {
    ...
    var newData = tableListData.data.concat();

    if (page.field) {
      var d = newData.filter(function (item) {
  ...
  'POST /api/users': function POSTApiUsers(req, res) {
    setTimeout(function () {
  ...
  'DELETE /api/users': function DELETEApiUsers(req, res) {
    setTimeout(function () {
  ...
  'PUT /api/users': function PUTApiUsers(req, res) {
    setTimeout(function () {
